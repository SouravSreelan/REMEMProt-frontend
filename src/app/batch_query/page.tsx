...
const BatchQuery = () => {
  ...
  const handleLoadSample = () => {
    const selectedSpeciesData = speciesData.speciesSampleData.find(
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8  lg:py-14 mx-auto mt-12 lg:mt-0">
        <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14 ">
          ...
          <p className="text-md font-normal text-justify max-w-9xl">
            The batch query option enables the users to conduct a collective
            search for multiple proteins in a single query to obtain their
            association as membrane proteins, especially taking into account the
            information on their Transmembrane Domain (TM), or the interactions
            with the TM domain containing proteins, and further, if identified
            using any membrane enrichment methods.
          </p>
        </div>
          ...
          <CardContent className="">
            <div className="flex flex-col w-full gap-2 max-w-xl mx-auto">
              ...
              <div className="flex justify-end  gap-2 mt-5">
                ...
                >
                  <Button disabled={!species} onClick={(e) => handleSubmit(e)}>
                    Submit
                  </Button>
                </Link>
              </div>
