    ...
    return (
        <div>
           <div className="max-w-2xl mx-auto text-center mb-10 mt-12 lg:mb-14 ">
                    ...
                    <p className='text-md font-normal text-center max-w-9xl mb-3'> The data for disease-protein association is retrieved from the <a className='no-underline hover:underline' href="https://www.disgenet.org/dbinfo" target='__blank'> DisGeNET database</a></p>
                </div>
