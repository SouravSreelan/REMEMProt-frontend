...
const Hero = () => {
  return (
    <div className="relative overflow-hidden">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 h-max w-full m-auto grid grid-cols-2 -space-x-42 opacity-40 dark:opacity-20"
      >
          ...
          <div className="max-w-5xl text-center mx-auto">
            ...
            <div className="max-w-screen-9xl px-4 py-32 lg:flex  lg:items-center">
              <h1 className="block font-semibold text-black text-4xl md:text-5xl lg:text-7xl w-full">
                Resource of Experimental Membrane-Enriched Mass
                spectrometry-derived Proteome
              </h1>
            </div>
            {/* End Title */}

            <div className="lg:w-5xl -mt-10 lg:-mt-[5rem] text-center mx-auto">
              <p className="mt-8 mx-12 text-gray-700 dark:text-gray-300 text-center">
                Resource of Experimental Membrane-Enriched Mass
